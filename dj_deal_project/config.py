...
MIN_PRICE = int(os.getenv("MIN_PRICE", 5))
MIN_PROFIT = int(os.getenv("MIN_PROFIT", 5))
LOCAL_RESALE_FACTOR = float(os.getenv("LOCAL_RESALE_FACTOR", 0.82))

SOLD_SEARCH_LIMIT = int(os.getenv("SOLD_SEARCH_LIMIT", 40))

CRAIGSLIST_REGIONS = [
    "newyork","philadelphia","southjersey",
    "jerseyshore","delaware","baltimore"
]
...
# --- SHOW MORE DEALS ---
ALERT_TOP_N = int(os.getenv("ALERT_TOP_N", 20))
...
RADAR_MIN_MARGIN = float(os.getenv("RADAR_MIN_MARGIN", 0.05))
